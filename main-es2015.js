...
let AddCompanyComponent = class AddCompanyComponent {
    constructor(myAdminService, router) {
    ...
    addCompany() {
        this.myAdminService.addNewCompany(this.company).subscribe(Response => {
            alert("company is added with id:" + Response.id), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
...
let AddCouponComponent = class AddCouponComponent {
    constructor(myCompanyService, router) {
    ...
    addCoupon() {
        this.myCompanyService.addNewCoupon(this.coupon).subscribe(Response => {
            alert("coupon is added with id:" + Response.id), this.router.navigate(['company']);
        }, error => {
            alert(error.error);
...
let AddCustomerComponent = class AddCustomerComponent {
    ...
    addCustomer() {
        this.myAdminService.addNewCustomer(this.customer).subscribe(Response => {
            alert("customer is added with id:" + Response.id), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
            this.router.navigate(['admin']);
        });
...
let DeleteCompanyComponent = class DeleteCompanyComponent {
    ...
    deleteCompany() {
        this.myAdminService.deleteCompany(this.company.id).subscribe(Response => {
            alert("company delete"), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
            this.router.navigate(['admin']);
        });
...
let DeleteCouponComponent = class DeleteCouponComponent {
    ...
    deleteCoupon() {
        this.MyCompanyService.deleteCoupon(this.coupon.id).subscribe(Response => {
            alert("coupon was deleted"), this.router.navigate(['company']);
        }, error => {
            alert(error.error);
            this.router.navigate(['company']);
        });
...
let DeleteCustomerComponent = class DeleteCustomerComponent {
    ...
    deleteCustomer() {
        this.myAdminService.deleteCustomer(this.customer.id).subscribe(Response => {
            alert("the delete is sucsess !!!"), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
            this.router.navigate(['admin']);
        });
...
let GetAllCompaniesComponent = class GetAllCompaniesComponent {
    ...
    ngOnInit() {
        this.myAdminService.getAllCompanies().subscribe(companies => {
...
let GetAllCouponForCustomerByCategoryComponent = class GetAllCouponForCustomerByCategoryComponent {
    constructor(myCustomerService) {
    ...
    getCouponbyCategory() {
        this.myCustomerService.getAllCouponForCustomerByCategory(this.category).subscribe(coupons => {
            this.coupons = coupons;
        });
    }
};
GetAllCouponForCustomerByCategoryComponent.ctorParameters = () => [
...
let GetAllCouponForCustomerByMaxPriceComponent = class GetAllCouponForCustomerByMaxPriceComponent {
    constructor(myCustomerService) {
        this.myCustomerService = myCustomerService;
        this.coupons = new Array();
    }
    ...
    getCouponsbyMaxPrice() {
        this.myCustomerService.getAllCouponForCustomerByMaxPrice(this.maxPrice).subscribe(coupons => {
            this.coupons = coupons;
            console.log(coupons);
        });
    }
};
GetAllCouponForCustomerByMaxPriceComponent.ctorParameters = () => [
    { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] }
];
...
let GetAllCouponForCustomerComponent = class GetAllCouponForCustomerComponent {
    constructor(MyCustomerService) {
        this.MyCustomerService = MyCustomerService;
        this.coupons = new Array();
    }
    ngOnInit() {
        this.MyCustomerService.getAllCouponForCustomer().subscribe(coupons => {
            this.coupons = coupons;
            console.log(coupons);
        });
    }
};
GetAllCouponForCustomerComponent.ctorParameters = () => [
    { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] }
];
...
let GetAllCouponToBuyCustomerComponent = class GetAllCouponToBuyCustomerComponent {
    constructor(myCustomerService, router) {
        this.myCustomerService = myCustomerService;
        this.router = router;
        this.coupons = new Array();
    }
    ngOnInit() {
        this.myCustomerService.GetAllCouponToBuyCustomer().subscribe(coupons => {
            this.coupons = coupons;
            console.log(coupons);
        });
    }
    buyMe(coupon) {
        this.myCustomerService.purchaseCoupon(coupon).subscribe(coup => {
            alert("thank you!!!! ,you purchase coupon with coupon id:" + coup.id), this.router.navigate(['customer']);
        }, error => {
            alert(error.error);
...
GetAllCouponToBuyCustomerComponent.ctorParameters = () => [
    { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
...
let GetAllCouponComponent = class GetAllCouponComponent {
    constructor(MycompanyService) {
        this.MycompanyService = MycompanyService;
        this.coupons = new Array();
    }
    ngOnInit() {
        this.MycompanyService.getAllCouponForCompany().subscribe(coupons => {
            this.coupons = coupons;
            console.log(coupons);
        });
    }
};
GetAllCouponComponent.ctorParameters = () => [
...
let GetAllCustomersComponent = class GetAllCustomersComponent {
    ...
    ngOnInit() {
        this.myAdminService.getAllCustomers().subscribe(customers => {
...
let GetCompanyDetailsComponent = class GetCompanyDetailsComponent {
    ...
    ngOnInit() {
        this.myCompanyService.getCompanyDetails().subscribe(Response => {
...
let GetCouponByCategoryComponent = class GetCouponByCategoryComponent {
    constructor(myCompanySrvice) {
    ...
    getCouponbyCategory() {
        this.myCompanySrvice.getAllCouponForCompanyByCategory(this.category).subscribe(coupons => {
            this.coupons = coupons;
        });
    }
};
GetCouponByCategoryComponent.ctorParameters = () => [
    { type: src_app_services_company_service__WEBPACK_IMPORTED_MODULE_2__["CompanyService"] }
];
...
let GetCouponByMaxPriceComponent = class GetCouponByMaxPriceComponent {
    constructor(myCompanySrvice) {
        this.myCompanySrvice = myCompanySrvice;
        this.coupons = new Array();
    }
    ...
    getCouponbyMaxPrice() {
        this.myCompanySrvice.getAllCouponForCompanyByMaxPrice(this.maxPrice).subscribe(coupons => {
            this.coupons = coupons;
            console.log(coupons);
        });
    }
};
GetCouponByMaxPriceComponent.ctorParameters = () => [
    { type: src_app_services_company_service__WEBPACK_IMPORTED_MODULE_2__["CompanyService"] }
];
...
let GetOneCompanyComponent = class GetOneCompanyComponent {
    ...
    getOneCompamy() {
        this.myAdminService.getOneCompany(this.company.id).subscribe(company => {
...
let GetOneCustomerComponent = class GetOneCustomerComponent {
    ...
    getOneCustomer() {
        this.myAdminSrvice.getOneCustomer(this.customer.id).subscribe(customer => {
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        this.loginService.login(this.email, this.password, this.type).subscribe(result => {
...
let LogoutComponent = class LogoutComponent {
    constructor(logoutService, router) {
...
let UpdateCompanyComponent = class UpdateCompanyComponent {
    ...
    updateCompany() {
        this.myAdminService.updateCompany(this.company).subscribe(Response => {
            alert("the update is sucsess !!!company id:" + Response.id), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
            this.router.navigate(['admin']);
        });
...
let UpdateCouponComponent = class UpdateCouponComponent {
    ...
    updateCoupon() {
        this.myCompanyService.updateCoupon(this.coupon).subscribe(Response => {
            alert("the update is sucsess !!!coupon id:" + Response.id), this.router.navigate(['company']);
        }, error => {
            alert(error.error);
            this.router.navigate(['company']);
        });
...
let UpdateCustomerComponent = class UpdateCustomerComponent {
    ...
    updateCustomer() {
        this.myAdminService.updateCustomer(this.customer).subscribe(Response => {
            alert("the update is sucsess !!!company id:" + Response.id), this.router.navigate(['admin']);
        }, error => {
            alert(error.error);
            this.router.navigate(['admin']);
